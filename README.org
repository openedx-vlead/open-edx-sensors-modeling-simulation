...
- Fill the course name : Sensor Modeling and Simulation
- Fill the Organisation as : COE-Pune
- Fill the Course Number : EEE05
- Fill the Course Run : Anytime
- Click on =CREATE=
- Click on =Tools= tab on top and click on =Import= option
- For choosing the file to import, clone the lab repository from (https://github.com/vlead/open-edx-sensors-modeling-simulation)
  GitHub.
